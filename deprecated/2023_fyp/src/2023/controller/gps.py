...
class GPSCoord:
    ...
    def __init__(self, latitude, longitude, altitude, variances=[-1, -1, -1]):
        self.lat = latitude
        self.long = longitude
        self.alt = altitude
        self.var = variances
    ...
    def __str__(self):
        return "GPS({:.6f}, {:.6f}, {:.6f}, var={})".format(self.lat, self.long, self.alt, self.var)
    ...
    def get_heading(self, other): 
        """ Returns the (global) heading between this GPSCoord and another 
        GPSCoord. 
