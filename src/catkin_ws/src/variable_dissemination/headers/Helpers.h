...
public:
     ...
     */
    template <typename T>
    void serializeInt(std::vector<std::byte>& buffer, T value);
     ...
     */
    void serializeString(std::vector<std::byte>& buffer, const std::string& str);
     ...
     */
    void serializeBytes(std::vector<std::byte>& buffer, const std::vector<std::byte>& data);
     ...
     */
    void serializeVarSpec(std::vector<std::byte>& buffer, const VarSpec& spec);
     ...
     */
    void serializeVarUpd(std::vector<std::byte>& buffer, const VarUpd& upd);
     ...
     */
    void serializeVarCreate(std::vector<std::byte>& buffer, const VarCreate& varCreate);
     ...
     */
    void serializeVarSumm(std::vector<std::byte>& buffer, const VarSumm& varSumm);
     ...
     */
    void serializeInformationElement(std::vector<std::byte>& buffer, const InformationElement& informationElement);
     ...
     */
    std::vector<std::byte> serializeVarCreateList(const std::vector<VarCreate>& varCreateList);
     ...
     */
    template <typename T>
    T deserializeInt(const std::vector<std::byte>& buffer, size_t& offset);
     ...
     */
    std::string deserializeString(const std::vector<std::byte>& buffer, size_t& offset);
     ...
     */
    std::vector<std::byte> deserializeBytes(const std::vector<std::byte>& buffer, size_t& offset);
     ...
     */
    VarSpec deserializeVarSpec(const std::vector<std::byte>& buffer, size_t& offset);
     ...
     */
    VarUpd deserializeVarUpd(const std::vector<std::byte>& buffer, size_t& offset);
     ...
     */
    VarCreate deserializeVarCreate(const std::vector<std::byte>& buffer, size_t& offset);
     ...
     */
    VarSumm deserializeVarSumm(const std::vector<std::byte>& buffer, size_t& offset);
     ...
     */
    InformationElement deserializeInformationElement(const std::vector<std::byte>& buffer, size_t& offset);
     ...
     */
    std::vector<VarCreate> deserializeVarCreateList(const std::vector<std::byte>& buffer);
     ...
     */
    std::vector<VarUpd> deserializeVarUpdList(const std::vector<std::byte>& buffer);
     ...
     */
    std::vector<VarSumm> deserializeVarSummList(const std::vector<std::byte>& buffer);
     ...
     */
    std::vector<uint8_t> deserializeVarIdList(const std::vector<std::byte>& buffer);
