...
main() {
    ...
    exec /opt/ros/humble/bin/ros2 launch "${SWARM_PATH}/drone_launch/drone.launch.py" > "$STDOUT_LOG" 2> "$STDERR_LOG"

    # nohup /opt/ros/humble/bin/ros2 launch "${SWARM_PATH}/drone_launch/drone.launch.py" > "$STDOUT_LOG" 2> "$STDERR_LOG"
}

source "${SWARM_PATH}/drone_launch/install/setup.bash"


main


# exec /opt/ros/humble/bin/ros2 launch /home/ros/drones/uav-formations-fyp-2024/swarm_ws/drone_launch/drone.launch.py > "$STDOUT_LOG" 2> "$STDERR_LOG"
